      ...
      <div className=" basis-[40%] flex flex-col h-screen items-center">
        ...
        <form className=" basis-[55%] w-[65%]" action="">
          ...
          <div className="flex flex-col items-center gap-4  ">
            {/* login methods */}
            <button className=" bg-customDark rounded-full px- text-white w-full" type="submit">
              Log in
            </button>
            <a
              href=""
              className=" bg-customGray rounded-full px- justify-center w-full flex gap-4 flex-shrink-0 min-w-max items-center"
            >
