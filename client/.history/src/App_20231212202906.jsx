      ...
      <div className=" basis-[40%] flex flex-col h-screen items-center">
        ...
        <form className=" basis-[60%] w-[65%]" action="">
          ...
          <div className=" flex flex-col gap-1">
            ...
            <input type="email" id="email" name="email" className=" border-b border-customDark rounded-sm outline-none py-1.5" placeholder="Ex: email_81194@gmail.com"  />
          </div>

          <div className="flex flex-co mt-8">
            <label htmlFor="pwd">Password</label>
            <input type="password" id="pwd" name="pwd" className=" border-b border-customDark rounded-sm outline-none py-1.5" placeholder="Enter your password"  />
          </div>
          ...
          <div className="flex flex-col items-center gap-4  ">
            {/* login methods */}
            <button className=" bg-customDark rounded-full p-2.5 tracking-wider font-medium text-white w-full" type="submit">
              Log in
            </button>
            <a
              href=""
