  ...
  return (
    <div className=" flex px-20 py-12 w-full justify-between">
      ...
      <ul className="flex gap-[4rem]">
        <li className=" font-semibold opacity-90">About</li>
        <li className=" font-semibold opacity-90">Events</li>
        <li className=" font-semibold opacity-90">Home</li>
        <li className=" font-semibold opacity-90">Our games</li>
        <li className=" font-semibold opacity-90">Inventories</li>
      </ul>
