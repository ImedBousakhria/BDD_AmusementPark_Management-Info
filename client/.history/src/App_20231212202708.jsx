      ...
      <div className=" basis-[40%] flex flex-col h-screen items-center">
        ...
        <form className=" basis-[60%] w-[65%]" action="">
          ...
          <div className=" flex flex-col gap-1">
            ...
            <input type="email" id="email" name="email" className=" border-b border-customDark rounded-sm outline-none py-1.5" placeholder=""  />
          </div>

          <div className="flex flex-col gap-1 mt-4">
            <label htmlFor="pwd">Password</label>
            <input type="password" id="pwd" name="pwd" className=" border-b border-customDark rounded-sm outline-none py-1.5" placeholder=""  />
          </div>

          <div className="flex justify-between mb-6 mt-1">
            {/* password actions */}
