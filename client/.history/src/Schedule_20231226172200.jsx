...
import * as AdapterMoment from "@mui/x-date-pickers/AdapterMoment";
...
const Schedule = () => {
  ...
  const FormBasicLayout = (props) => {
    ...
    const handleChange = (color) => {
      setSelectedColor(color);    onFieldChange({ color: selectedColor });
    ...
    return (
      <AppointmentForm.BasicLayout {...props}>
        <AppointmentForm.Container {...props}>
          ...
          <div onClick={() => console.log(props)}>Click me to print stuff</div>
