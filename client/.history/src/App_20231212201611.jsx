      ...
      <div className=" basis-[40%] flex flex-col h-screen items-center">
        ...
        <form className=" basis-[55%] w-[65%]" action="">
          ...
          <div className=" flex flex-col gap-1">
            ...
            <input type="email" name="email" className=" border-b border-customDark rounded-full py-1.5"  />
          </div>

          <div className="flex flex-col gap-1 mt-4">
            <label htmlFor="pwd">Password</label>
            <input type="password" name="pwd" className=" border-b border-customDark rounded-full py-1.5"  />
          </div>
