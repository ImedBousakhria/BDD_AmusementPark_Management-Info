        ...
        <div className=" flex flex-col gap-[4rem]">
          ...
          <div className=" flex  gap-[2rem]">
            <div className=" bg-customPink flex flex-col rounded-3xl py-6 px-7">
              <img src={food} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold te">Our Food</h3>
              <small className=" place-self-end my-3">See more {">"}</small>
            </div>
            <div className=" bg-customPurple flex flex-col rounded-3xl py-6 px-7">
              <img src={game} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold te">Our games</h3>
              <small className=" place-self-end my-3">See more {">"}</small>
            </div>
            <div className=" bg-customYellow flex flex-col rounded-3xl py-6 px-7">
              <img src={amus} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold te">AmuseMap</h3>
              <small className=" place-self-end my-3">See more {">"}</small>
            </div>
            <div className=" bg-customBlue flex flex-col rounded-3xl py-6 px-7">
              <img src={stall} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold te">Our Gift Shops</h3>
              <small className=" place-self-end my-3">See more {">"}</small>
            </div>
          </div>
        </div>
