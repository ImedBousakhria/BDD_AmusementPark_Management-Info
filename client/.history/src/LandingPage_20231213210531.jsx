      ...
      <section className=" bg-grad flex flex-col items-center w-screen z-20 h-[85vh]">
        ...
        <div className=" flex flex-col gap-[4rem]">
          ...
          <div className=" flex  gap-[3.5rem]">
            <div className=" bg-customPink flex flex-col rounded-3xl py-">
              <img src={food} alt="" />
              <small>See more {">"}</small>
            </div>
            <div className=" bg-customPurple flex flex-col rounded-3xl py-">
              <img src={game} alt="" />
              <small>See more {">"}</small>
            </div>
            <div className=" bg-customYellow flex flex-col rounded-3xl py-">
              <img src={amus} alt="" />
              <small>See more {">"}</small>
            </div>
            <div className=" bg-customBlue flex flex-col rounded-3xl py-">
              <img src={stall} alt="" />
              <small>See more {">"}</small>
            </div>
          </div>
