    ...
    <div className=" overflow-x-hidden flex flex-col relative mx-auto items-center bg-primaryBG z-10 text-white ">
      ...
      <section className="bg-primaryBG h-screen flex flex-col items-center w-screen px-48 mx-auto ">
        ...
        <div className=" flex flex-col gap-[4rem]">
          ...
          <div className="flex">
            <div>
              <img src={ticketYellow} alt="" className=" w-[200%] " />
            </div>
            <div>
              <img src={ticketBlue} alt="" className=" w-[200%]" />
            </div>
            <div>
              <img src={ticketPink} alt="" className=" w-[200%] " />
            </div>
            <div>
              <img src={ticketPurple} alt="" className=" w-[200%] " />
            </div>
          </div>
        </div>
      </section>
