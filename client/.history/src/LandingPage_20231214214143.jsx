  ...
  return (
    <div className=" flex px-20 py-12 w-full justify-between">
      ...
      <ul className="flex gap-[4rem]">
        <li className=" font-semibold opacity-80 track">About</li>
        <li className=" font-semibold opacity-80 track">Events</li>
        <li className=" font-semibold opacity-80 track">Home</li>
        <li className=" font-semibold opacity-80 track">Our games</li>
        <li className=" font-semibold opacity-80 track">Inventories</li>
      </ul>
