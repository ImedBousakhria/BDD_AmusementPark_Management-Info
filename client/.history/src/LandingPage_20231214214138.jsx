  ...
  return (
    <div className=" flex px-20 py-12 w-full justify-between">
      ...
      <ul className="flex gap-[4rem]">
        <li className=" font-semibold opacity-80">About</li>
        <li className=" font-semibold opacity-80">Events</li>
        <li className=" font-semibold opacity-80">Home</li>
        <li className=" font-semibold opacity-80">Our games</li>
        <li className=" font-semibold opacity-80">Inventories</li>
      </ul>
