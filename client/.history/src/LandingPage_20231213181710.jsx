  ...
  return (
    <div className=" flex flex-col relative mx-auto bg-primaryBG -z-20 ">
      ...
      <section className=" bg-grad h-[80vh]">
        ...
        <div className=" flex">
          <div className=" bg-customPink flex flex-col"><img src={food} alt="" /></div>
          <div className=" bg-customPurple flex flex-col"><img src={game} alt="" /></div>
          <div className=" bg-customYellow flex flex-col"><img src={amus} alt="" /></div>
          <div className=" bg-customBlue flex flex-col"><img src={stall} alt="" /></div>
        </div>
      </section>
    </div>
  );
