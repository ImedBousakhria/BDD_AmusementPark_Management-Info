    ...
    return (
      ...
      >
        <AppointmentForm.Container {...props}>
          ...
          <div onClick={() => console.log(props, appointmentData.title)}>
            Click me to print stuff
          </div>
        </AppointmentForm.Container><div className="border-t border-gray-200 flex flex-col gap-4 px-8 py-2.5 font-semibold">
