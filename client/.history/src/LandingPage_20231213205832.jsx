...
const LandingPage = () => {
  return (
    <div className=" flex flex-col relative mx-auto items-center bg-primaryBG  text-white ">
      {/* grandparent wrapper */}
      <NavBar />
      {/* secondary bg */}
      <img
      ...
      />
      <section className="h-screen flex items-center w-screen justify-center z-20">
        {/* first section */}
        <div>
      ...
      <section className=" bg-grad flex flex-col items-center w-screen z-20 h-[85vh] my-10">
        {/* second section */}
      ...
      <section className="bg-primaryBG h-screen flex flex-col items-center w-screen z-20">
        {/* third section */}
