...
const Schedule = () => {
  ...
  const appointments = [
...

    {
      id: 6,
      title: "Test Task",
      startDate: new Date(2023, 0, 29, 8, 0).toUTCString /* "2023-12-29T09:00" */,
      endDate: new Date(2023, 0, 29, 9, 30).toUTCString() /* "2023-12-29T12:30" */,
      color: "#66D1F3",
    },
  ];
  ...
  const Appointment = ({ children, style, data, ...restProps }) => {
    return (
      <div onClick={() => console.log(typeof(moment(data.startDate).toDate().toUTCString()))}>
