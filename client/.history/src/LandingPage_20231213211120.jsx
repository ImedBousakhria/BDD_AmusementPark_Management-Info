      ...
      <section className=" bg-grad flex flex-col items-center w-screen z-20 h-[85vh]">
        ...
        <div className=" flex flex-col gap-[4rem]">
          ...
          <div className=" flex  gap-[2rem]">
            <div className=" bg-customPink flex flex-col rounded-3xl py-6 px-7 cursor-pointer">
              <img src={food} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold text-lg">
                Our Food
              </h3>
              <small className=" place-self-end my-3 opacity-75">
                See more {">"}
              </small>
            </div>
            <div className=" bg-customPurple flex flex-col rounded-3xl py-6 px-7 cursor-pointer">
              <img src={game} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold text-lg">
                Our games
              </h3>
            ...
            <div className=" bg-customYellow flex flex-col rounded-3xl py-6 px-7 cursor-pointer">
              <img src={amus} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold text-lg">
                AmuseMap
              </h3>
            ...
            <div className=" bg-customBlue flex flex-col rounded-3xl py-6 px-7 cursor-pointer">
              <img src={stall} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold text-lg">
                Our Gift Shops
              </h3>
