...
const LandingPage = () => {
  return (
    <div className=" flex flex-col relative mx-auto bg-primaryBG -z-20 text-white ">
      ...
      <footer className="bg-darkBG flex items-center justify-between px-24 py-10 ">
        {/* sixth section */}
        ...
        <div className=" flex flex-col">
          ...
          <div className=" flex gap-6 ">
            <a href="">
              <img src={twitter} className=" w-" alt="" />
            </a>
            <a href="">
              <img src={fb} className=" w-" alt="" />
            </a>
            <a href="">
              <img src={linkedin} className=" w-" alt="" />
            </a>
          </div>
        </div>
