...
const LandingPage = () => {
  return (
    <div className=" flex flex-col relative mx-auto items-center justify-center bg-primaryBG -z-20 text-white ">
      {/* grandparent wrapper */}
      <NavBar />
      {/* secondary bg */}
      <img
      ...
      />
      <section className="h-screen flex items-center w-screen justify-center">
        {/* first section */}
        <div>
      ...
      <section className=" bg-grad h-screen flex flex-col items-center w-screen z-20">
        {/* second section */}
      ...
      <section className="bg-primaryBG h-screen flex flex-col items-center w-screen">
        {/* third section */}
        <h1 className=" tracking-wider">Our Events</h1>
        <img src={placeholder} alt="" />
      </section>

      <section className="bg-primaryBG h-screen flex flex-col w-screen px-36 my-28 gap-[4rem]">
        {/* fourth section */}
      ...
      <footer className="bg-darkBG flex items-start justify-between w-screen px-24 py-10 ">
        ...
        <div className=" flex flex-col mt-16">
          {/* second bloc */}
          <h2 className=" mb-5 font-semibold text-2xl tracking-wider">Contact us</h2>
