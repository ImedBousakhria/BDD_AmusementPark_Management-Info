      ...
      <div className=" basis-[40%] flex flex-col items-center justify-center">
        ...
        <form className=" w-[80%]" action="">
          ...
          <div className="flex flex-col items-center  ">
            ...
            <a
              href=""
              className="bg-red-400 w-full flex gap-4 flex-shrink-0 min-w-max items-center"
            >
              <img src={google} className=" w-[15%] " alt="" />{" "}
              <span className=" flex-shrink-0">Log in with Google</span>
            </a>
          </div>
        </form>
      </div>
