...
const LandingPage = () => {
  return (
    <div className=" overflow-x-hidden flex flex-col relative mx-auto items-center bg-primaryBG -z-20 text-white ">
      {/* grandparent wrapper */}
      <NavBar />
      {/* secondary bg */}
      <img
      ...
      <section className=" bg-grad flex flex-col items-center w-screen z-20 h-[85vh]">
        ...
        <div className=" flex flex-col gap-[4rem]">
          ...
          <div className=" flex  gap-[2rem]">
            <div className=" bg-customPink flex flex-col rounded-3xl py-6 px-7 shadow-md shadow-customPink ">
              <img src={food} alt="" />
            ...
            <div className=" bg-customPurple flex flex-col rounded-3xl py-6 px-7 shadow-md shadow-customPurple ">
              <img src={game} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold text-lg">
                Our games
              </h3>
            ...
            <div className=" bg-customYellow flex flex-col rounded-3xl py-6 px-7 shadow-md shadow-customYellow ">
              <img src={amus} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold text-lg">
                AmuseMap
              </h3>
            ...
            <div className=" bg-customBlue flex flex-col rounded-3xl py-6 px-7 shadow-md shadow-customBlue ">
              <img src={stall} alt="" />
              <h3 className=" tracking-wider mt-4 font-semibold text-lg">
                Our Gift Shops
              </h3>
      ...
      <section className="bg-primaryBG h-screen flex flex-col items-center w-screen px-48 mx-auto ">
        ...
        <div className=" flex flex-col gap-[4rem]">
          ...
          <div className="flex gap-9">
            <div>
              <img src={ticketYellow} alt="" className=" shadow-md shadow-customYellow" />
            </div>
            <div>
              <img src={ticketBlue} alt="" className=" shadow-md shadow-customBlue" />
            </div>
            <div>
              <img src={ticketPink} alt="" className=" shadow-md shadow-customPink" />
            </div>
            <div>
              <img src={ticketPurple} alt="" className=" shadow-md shadow-customPurple" />
            </div>
          </div>
        </div>
      </section>
