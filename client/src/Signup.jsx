...
const signupSchema = Yup.object({
    ...
    email : Yup.email("Please enter a valid email").required("Please enter your email"),
    password : Yup.min(8,"Your password must be at least 8 characters long").matches(passwordRegex,"Please enter a valid password").required("Please enter a password"),
    cpassword : Yup.oneOf([Yup.ref(password)],"Password does not match").required("Please confirm your password"),
    phonenum : Yup.matches(numRegex,"Please enter a valid phone number").required("Please enter your phone number")
}); 
