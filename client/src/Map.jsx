...
const Map = () => {
  ...
  const markers = [
    ...
    { id: 2, position: [48.872, 2.775], imgSrc: markerImg2, bgColor: "#ff8d8d", content: "Marker 2: This area offers stunning views of the city skyline." },
    ...
    { id: 5, position: [48.872, 2.777], imgSrc: duck, bgColor: "#8cff8d"/* #ffcc80 */, content: "Duck Marker: Visit the tranquil duck pond and feed the ducks." },
