  ...
  return (
    <div className="flex flex-col min-h-screen bg-darkBG gap-[2rem]">
      <div className=" w-[50%] flex gap-6 place-self-start ">
        <Selector selectCategory={"Zone"} icon={zone} selectedOption={selectedZone} setSelectedOption={se} />
        <Selector selectCategory={"Team"} icon={team} selectedOption={selectedTeam} setSelectedOption={se} />
