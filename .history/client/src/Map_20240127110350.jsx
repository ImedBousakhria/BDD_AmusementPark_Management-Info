...
const createCustomIcon = (bgColor, imgSrc) => {
  return L.divIcon({
    ...
    iconSize: [50, 50],
    html: `<div style="background-color: ${bgColor}; width: 50px; height: 50px; border-radius: 50%; display: flex; justify-content: center; align-items: center;"><img src="${imgSrc}" style="max-width: 80%; max-height: 80%;" /></div>`,
  });
};
