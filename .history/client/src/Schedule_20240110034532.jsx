...
const Schedule = () => {
  ...
  const CustomTooltip = (props) => {
    ...
    return (
      <AppointmentTooltip.Content ></AppointmentTooltip.Content>
      <div style={{ display: "flex", flexDirection: "column", padding: 10 }}>
        <div style={{ fontWeight: "bold" }}>Test Task</div>
        <div onClick={() => console.log(props)}>Time: {title}</div>
        <div
          style={{
  ...
  return (
    <div className="flex flex-col  bg-darkBG gap-[2rem]">
      <div className=" w-[50%] flex gap-6 place-self-start ">
        ...
        <div className="bg-customBlue">Request</div>
      </div>
