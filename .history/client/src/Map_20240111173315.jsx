...
const Map = () => {
  ...
  const rectangleBounds = [[48.86, 2.75], [48.88, 2.80]]; // Adjust the bounds as needed
  ...
  return (
    ...
    >
      <TileLayer
        attribution="https://www.openstreetmap.org/?mlat=48.8598&mlon=2.7617#map=13/54.8598/2.7617"
