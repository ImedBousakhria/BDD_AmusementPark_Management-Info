...
const App = () => {
  return (
    <BrowserRouter>
      <Routes>
        <Route path={"/"} element={<LandingPage visitor={false}/>} />
        ...
        />
        <Route
          path={"/Visitor/Attraction"}
          element={<VisitorPage childComponent={<Attractions visitor={true} />} />}
        />
        <Route
          path={"/Visitor/Prizes"}
          element={<VisitorPage childComponent={<Attractions visitor={true} />} />}
        ...
        <Route
          path={"/Attraction"}
          element={<HomeLayout pageComponent={<Attractions visitor={false} />} />}
        />
        <Route
          path={"/Event"}
          element={<HomeLayout pageComponent={<AddEventForm />} />}
        />
        <Route
          path={"/Stall"}
