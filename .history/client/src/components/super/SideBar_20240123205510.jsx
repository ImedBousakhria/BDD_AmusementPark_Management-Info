...
const SideBar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  const sidebarVariants = {
    open: { width: "280px" }, // Width while SideBar's open
  ...
  return (
    ...
    >
      ...
      <div className="flex h-full items-end border-b border-b-gray-500 mb-2 w-full">
        <SidebarButton
          barState={isSidebarOpen}
          to="/Settings"
          icon={settings}
      ...
      <div className="flex px-2">
        <div className="flex items-center gap-3">
          ...
          <div className=" flex flex-col">
            <h4 className=" font-medium">Imed Bousakhria</h4> <small className=" text-gray-300"> ImedBousakhria@gmail.com</small> 
          </div>
          <img src={logout} className="w-8 cursor-pointer" alt="" />
        </div>
      </div>
    </motion.div>
  );
