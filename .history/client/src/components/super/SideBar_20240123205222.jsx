...
import lougout from "../../assets/icons/lougout.svg";
      ...
      <div className="flex px-2">
        <div className="flex items-center gap-3">
          ...
          <div className=" flex flex-col">
            <h4 className=" font-medium">Imed Bousakhria</h4> <small className=" text-gray-300"> ImedBousakhria@gmail.com</small> <img src={logout} alt="" />
          </div>
        </div>
      </div>
    </motion.div>
