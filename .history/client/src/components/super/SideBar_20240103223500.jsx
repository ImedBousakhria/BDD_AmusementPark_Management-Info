...
const SideBar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  return (
    <motion.div
      ...
      className={` w-[25%] fixed z-50 h-screen bg-lightBG text-white p-4 flex flex-col `}
    >
      <div>
        <div className=" flex gap-[2rem] items-center ">
          <h3 className="cursor-pointer" onClick={() => setIsSidebarOpen(!isSidebarOpen)}>{"Reduce Bar"}</h3>
          <img
            src={logo}
            alt="Your Logo"
            className={`${
