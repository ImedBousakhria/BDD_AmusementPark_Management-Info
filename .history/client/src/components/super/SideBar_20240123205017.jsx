...
const SideBar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex h-full items-end border-b border-b-slate-300 mb-2 w-full">
        <SidebarButton
          barState={isSidebarOpen}
          to="/Settings"
          icon={settings}
      ...
      <div className="flex px-2">
        <div className="flex items-center gap-5">
          <img src={lpfp} className=" w-5" alt="" />{" "}
          <div className=" flex flex-col">
            <h4>Imed Bousakhria</h4> <small> ImedBousakhria@gmail.com</small>{" "}
          </div>
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <Link
        ...
        className={`flex items-center px-2 rounded-lg transition-colors  my-4 flex-shrink-0 ${
