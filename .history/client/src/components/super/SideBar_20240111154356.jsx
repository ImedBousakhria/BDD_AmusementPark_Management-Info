...
function SidebarButton({
  ...
  return (
    <li className={` ${barState ? " w-full  " : " w-max "} list-none `}  onClick={onClick}>
      <Link
        to={to}
        onClick={() => toggleDropDown()}
        className={`flex items-center py-2 px-2 min-w-max rounded-lg transition-colors  my-4 flex-shrink-0 ${
