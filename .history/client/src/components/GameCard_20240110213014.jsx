...
const GameCard = ({ attraction }) => {
  return (
    <div className="flex flex-col bg-white h-[210px] min-h-max w-[350px] min-w-max rounded-md p-2">
      <img
        src={moredots}
...
const Details = ({ game, userType  }) => {
  ...
  return (
    <div className="flex flex-col p-3">
      <h3 className="overflow-hidden">{game.title}</h3>
      <Rating
      ...
      />
      <small className="text-gray-400 mt-4">{game.genre}</small>
      <small className="text-gray-500">{game.age}</small>
