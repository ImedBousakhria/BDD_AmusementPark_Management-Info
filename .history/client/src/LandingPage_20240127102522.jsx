        ...
        <div className="flex flex-col gap-[4rem]">
          ...
          <div className="flex justify-center gap-[6rem]">
            <div className="text-center relative">
              ...
              <div className="text-4xl text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                {days}
              </div>
            </div>
            <div className="text-center relative">
              <img src={ticketBlue} alt="" className="" />
              <div className="text-4xl text-5 text-white absolute top-[30%] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                {hours}
              </div>
            </div>
            <div className="text-center relative">
