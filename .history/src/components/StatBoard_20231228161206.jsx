...
const StatBoard = () => {
  return (
    <div className="flex justify-between bg-white py-5 px-3 w-[80%] rounded-lg">
      <div className=" flex flex-col gap-3  items-center min-w-max border-r ">
      ...
      <div className=" flex flex-col gap-3  items-center min-w-max border-r border-l ">
      ...
      <div className=" flex flex-col gap-3  items-center min-w-max border-l ">
