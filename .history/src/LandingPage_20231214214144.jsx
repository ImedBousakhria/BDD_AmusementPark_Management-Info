  ...
  return (
    <div className=" flex px-20 py-12 w-full justify-between">
      ...
      <ul className="flex gap-[4rem]">
        <li className=" font-semibold opacity-80 tracking-wide">About</li>
        <li className=" font-semibold opacity-80 tracking-wide">Events</li>
        <li className=" font-semibold opacity-80 tracking-wide">Home</li>
        <li className=" font-semibold opacity-80 tracking-wide">Our games</li>
        <li className=" font-semibold opacity-80 tracking-wide">Inventories</li>
      </ul>
