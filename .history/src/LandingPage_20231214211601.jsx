...
const LandingPage = () => {
  return (
    <div className=" overflow-x-hidden flex flex-col relative mx-auto items-center bg-primaryBG z-10 text-white ">
      ...
      />
      <section className="h-screen flex items-center w-screen justify-center my-10 mx-40 ">
        {/* first section */}
        <div className=" ml-20 w-[30%] ">
         <p className="opacity-80 leading-relaxed text-xl">Lorem ipsum is a placeholder text commonly used to demonstrate the
