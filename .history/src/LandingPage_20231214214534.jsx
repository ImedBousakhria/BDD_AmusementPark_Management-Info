  ...
  return (
    <div className=" flex items-center px-20 py-12 w-full justify-between">
      ...
      <div className="flex gap-[1rem]">
        <a
          href=""
          className=" flex items-center font-semibold text-primaryBG bg-white text-center py-2 px-4"
        >
          Log In
        </a>
        <a href="" className="flex items-center font-semibold border-4 py-2 px-4">
          Sign Up
        </a>
      </div>
    </div>
