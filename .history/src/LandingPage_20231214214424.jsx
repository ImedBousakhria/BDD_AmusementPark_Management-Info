...
const LandingPage = () => {
  return (
    <div className=" overflow-x-hidden flex flex-col relative mx-auto items-center bg-primaryBG z-10 text-white ">
      ...
      />
      <section className="h-screen flex  w-screen justify-center my-10 mx-40 ">
        {/* first section */}
      ...
      <section className="bg-primaryBG h-[90vh] mb-20 flex flex-col items-center justify-center w-screen z-20">
        {/* third section */}
        <h2 className=" tracking-wider ">Our Events</h2>
        <img src={placeholder} className=" w-[70%]" alt="" />
      </section>

      <section className="bg-primaryBG h-screen flex flex-col items-center w-screen px-40 mx-auto ">
        {/* fourth section */}
        <div className=" flex flex-col gap-[4rem]">
...
function NavBar() {
  return (
    <div className=" flex px-20 py-12 w-full justify-between">
      <img src={logo} alt="" />
      <ul className="flex gap-[4rem]">
        <li className=" font-semibold opacity-80 tracking-wider cursor-pointer">About</li>
        <li className=" font-semibold opacity-80 tracking-wider cursor-pointer">Events</li>
        <li className=" font-semibold opacity-80 tracking-wider cursor-pointer">Home</li>
        <li className=" font-semibold opacity-80 tracking-wider cursor-pointer">Our games</li>
        <li className=" font-semibold opacity-80 tracking-wider cursor-pointer">Inventories</li>
      </ul>
      <div className="flex gap-[1rem]">
      <a href="" className=" font-semibold text-primaryBG bg-white text-center">Log In</a>
      <a href="" className=" font-semibold border-4">Sign Up</a>
      </div>
