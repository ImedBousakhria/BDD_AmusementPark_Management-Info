...
const LandingPage = () => {
  return (
    <div className=" flex flex-col relative mx-auto bg-primaryBG -z-20 text-white ">
      {/* grandparent wrapper */}
      <NavBar />
      {/* secondary bg */}
      <img
      ...
      <section className="bg-primaryBG justify-self-center h-screen flex items-center px-6">
        {/* fifth section */}
      ...
      <footer className="bg-darkBG flex items-start justify-between px-24 py-10 ">
        {/* sixth section */}
