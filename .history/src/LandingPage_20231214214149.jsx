  ...
  return (
    <div className=" flex px-20 py-12 w-full justify-between">
      ...
      <ul className="flex gap-[4rem]">
        <li className=" font-semibold opacity-80 tracking-wider">About</li>
        <li className=" font-semibold opacity-80 tracking-wider">Events</li>
        <li className=" font-semibold opacity-80 tracking-wider">Home</li>
        <li className=" font-semibold opacity-80 tracking-wider">Our games</li>
        <li className=" font-semibold opacity-80 tracking-wider">Inventories</li>
      </ul>
