  ...
  return (
    ...
    >
      ...
      <ul className="flex gap-[4rem]">
        <motion.li  whileHover={{ scale: 1.2, originX: 0, color: "#ffd241" }}
              transition={{ type: "spring", stiffness: 300 }} className=" font-semibold opacity-80 tracking-wider cursor-pointer">
          About
        </motion.li>
        <motion.li  whileHover={{ scale: 1.2, originX: 0, color: "#ffd241" }}
              transition={{ type: "spring", stiffness: 300 }}className=" font-semibold opacity-80 tracking-wider cursor-pointer">
