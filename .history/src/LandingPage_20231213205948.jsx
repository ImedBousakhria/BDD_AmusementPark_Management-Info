...
const LandingPage = () => {
  return (
    <div className=" flex flex-col relative mx-auto items-center bg-primaryBG -z-20 text-white ">
      ...
      />
      <section className="h-screen flex items-center w-screen justify-center py-10 ">
        {/* first section */}
        <div>
      ...
      <section className=" bg-grad flex flex-col items-center w-screen z-20 h-[100vh] py-10">
        {/* second section */}
