...
function NavBar() {
  return (
    <div className=" flex items-center px-20 py-12 w-full justify-between">
      <img src={logo} alt="" />
      <ul className="flex gap-[4rem]">
        <li className=" font-semibold opacity-80 tracking-wider cursor-pointer">
          About
        </li>
        <li className=" font-semibold opacity-80 tracking-wider cursor-pointer">
          Events
      ...
      <div className="flex gap-[1rem]">
        <a
          href=""
          className=" flex items-center font-semibold text-primaryBG bg-white text-center py-1 px-3.5 rounded-3xl"
        >
          Log In
        </a>
        <a href="" className="flex items-center font-semibold border-4 py-1 px-3.5 rounded-3xl">
          Sign Up
        </a>
      </div>
    </div>
