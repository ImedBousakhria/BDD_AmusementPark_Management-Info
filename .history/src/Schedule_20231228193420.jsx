...
import { Toolbar } from "@devexpress/dx-react-scheduler-material-ui/dist/dx-react-scheduler-material-ui";
  ...
  const appointments = [
    {
      id: 1,
      title: "Test Task",
      startDate: "2023-12-29T11:00Z",
      endDate: "2023-12-29T15:30Z",
      color: "#C3C2FF",
    },
    {
      id: 5,
      title: "Test Task",
      startDate: "2023-12-25T09:00Z",
      endDate: "2023-12-25T10:30Z",
      color: "#C3C2FF",
    },
    {
      id: 2,
    ...
    <div className=" flex items-center justify-center py-6 h-screen bg-darkBG">
      <Paper style={{ width: "90%", height: 600 }}>
        <Scheduler data={appointments}>
          ...
          <Toolbar flexibleSpaceComponent={CustomTooltip} />
