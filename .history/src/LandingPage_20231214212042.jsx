  ...
  return (
    <div className=" overflow-x-hidden flex flex-col relative mx-auto items-center bg-primaryBG z-10 text-white ">
      ...
      <section className="h-screen flex  w-screen justify-center my-10 mx-40 ">
        {/* first section */}
        <div className=" ml-20 w-[35%] mt-[10%]  ">
          <p className="opacity-80 leading-relaxed text-xl tracking-wide mb-14">
            Lorem ipsum is a placeholder text commonly used to demonstrate the
            visual form of a document. Lorem ipsum is a placeholder text commonly used to demonstrate the
            visual form of a document. 
          </p>
          <a href="" className=" bg-customYellow text-black shadow-lg shadow-customYellow py-2.5 px-5 rounded-3xl font-semibold opacity-70">
            See more
          </a>
        </div>
